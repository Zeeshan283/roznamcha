                        ...
                        <form action="{{ route('admin.roznamchas.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row mb-3" style="display: flex; flex-wrap:wrap; justify-content: space-between">
                                <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <select class="form-control" id="country" name="country" {{ $currency=="all" ? 'required' : 'enable' }}>
                                        <option value="all" {{ $currency=="all"? 'selected disabled' : '' }}>Select Country</option>
                                        <option value="Pakistan" {{ $currency=="PK"? 'selected disabled' : '' }}>Pakistan</option>
                                        <option value="Afghanistan" {{ $currency=="AF"? 'selected disabled' : '' }}>Afghanistan</option>
                                        <option value="USA" {{ $currency=="USD"? 'selected disabled' : '' }}>USA</option>
                                    </select>
                                    @if($currency=="PK")
                            ...
                            <div class="form-row mb-3" style="display: flex; flex-wrap:wrap; justify-content: space-between">
                                ...
                                <div class="form-group col-md-4 col-sm-12">
                                    <label id="countryLabel">Amount</label>
                            ...
                            <div class="form-row mb-3" style="display: flex; flex-wrap:wrap; justify-content: space-between">
                                ...
                                {{-- @if ($currency=='AF')
                                    <div class="form-group col-md-4 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" id="afghani" name="afghani" placeholder="Enter Details">
                                    </div>
                                @endif --}}
