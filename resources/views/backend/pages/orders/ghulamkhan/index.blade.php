                                ...
                                <tbody>
                                    ...
                                    @foreach ($GhulamkhanOrders as $data)
                                        <tr>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-content" id="dropdownContent">
                                                        <a href="{{ route('ghulamkhan.invoice', $data['id']) }}"
                                                            class="fa fa-eye text-dark">Invoice</a>
                                                        <a href="{{ route('ghulamkhan.images', $data['id']) }}"
                                                            class="fa fa-info-circle text-dark">Detail</a>
                                                        <a href="{{ route('admin.orders.ghulamkhan.edit', $data->id) }}"
                                                            class="fa fa-edit text-dark">Edit</a>
                                                        <a href="{{ route('admin.orders.ghulamkhan.destroy1', $data->id) }}"
                                            ...
                                            <td>
                                                <a href="{{ route('admin.khata.personal.index', $data['admin']['id']) }}">{{ $data['admin']['name'] }}</a>
                                            </td>
                                            ...
                                            @if ($matchedSelf)
                                                <td><a href="{{ route('admin.khata.personal.index', $matchedexpense['admin']['id']) }}">{{ $matchedexpense['admin']['name'] }}</a></td>
