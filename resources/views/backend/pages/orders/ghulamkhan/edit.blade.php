...
@section('title')
    Update New Order Ghulamkhan - Roznamcha
@endsection
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Update Order Ghulamkhan</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Update Order Ghulamkhan</h4>
                        @include('backend.layouts.partials.messages')
                        <form action="{{ route('admin.orders.ghulamkhan.update', ['ghulamkhan' => $record->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="self">
                                @if($self_expense)
                                    <form class="table-responsive" action="{{ route('admin.order.updategselfexpense', ['id' => $self_expense->id]) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="self">
                                @if($roznamcha)
                                    <form class="table-responsive" action="{{ route('admin.order.updateroznamchasg', ['id' => $roznamcha->id]) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="self">
                            @if($self)
                                <form class="table-responsive" action="{{ route('admin.order.updategself', ['id' => $self->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                            ...
                            @else
                                <form class="table-responsive" action="{{ route('admin.order.gself') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
