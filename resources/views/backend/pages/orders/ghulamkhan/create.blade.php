...
@section('title')
    Create New Order Ghulamkhan - Roznamcha
@endsection
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Create Order Ghulamkhan</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Create Order Ghulamkhan</h4>
                        @include('backend.layouts.partials.messages')

                        <form action="{{ route('admin.orders.ghulamkhan.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                ...
                                <div class=" row append_data" id="order_form">
                                    ...
                                    <div class="col-sm-4 mb-2">
                                        ...
                                        <input class="form-control" autocomplete="off" name="n_plate" type="text"
                                            id="city">
                                    </div>
                                    <div class="col-sm-4 mb-2">
