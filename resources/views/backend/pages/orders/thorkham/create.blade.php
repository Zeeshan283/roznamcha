...
@section('title')
    Create New Order Thorkham - Roznamcha
@endsection
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Create Order Thorkham</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Create Order Thorkham</h4>
                        @include('backend.layouts.partials.messages')

                        <form action="{{ route('admin.orders.thorkham.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="self">
                                <form class="table-responsive" action="{{ route('admin.order.tself') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
