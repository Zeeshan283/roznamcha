        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-end">
                @if (Auth::guard('admin')->user()->can('orders.thorkham.edit'))
                    <a class="btn btn-rounded btn-primary" href="{{ route('admin.orders.thorkham.create') }}">Create New Order</a>
                @endif
            </div>
        </div>
    </div>
                                    ...
                                    <td> 
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-content" id="dropdownContent">
                                                <a href="{{ route('admin.orders.thorkham.show', $data->id) }}" class="fa fa-eye text-dark">View</a>
                                                <a href="{{ route('admin.orders.thorkham.edit', $data->id) }}" class="fa fa-edit text-dark">Edit</a>
                                                <a href="{{ route('admin.orders.thorkham.destroy1', $data->id) }}" class="fa fa-trash text-black" data-record-id="{{ $data->id }}">Delete</a>
                                            </div>
                                        </div>   
                                    </td>     
                                    <td>{{$data['date'] }}</td>                                         
