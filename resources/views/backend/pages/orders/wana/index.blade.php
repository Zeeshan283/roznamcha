            ...
            <div class="col-5 align-self-center">
                <div class="customize-input float-end">
                    @if (Auth::guard('admin')->user()->can('orders.wana.edit'))
                        <a class="btn btn-rounded btn-primary" href="{{ route('admin.orders.wana.create') }}">Create New
                            Order</a>
                    @endif
                </div>
            </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-content" id="dropdownContent">
                                                        <a href="{{ route('wana.invoice', $data['id']) }}"
                                                            class="fa fa-eye text-dark">Invoice</a>
                                                        <a href="{{ route('wana.images', $data['id']) }}"
                                                            class="fa fa-info-circle text-dark">Detail</a>
                                                        <a href="{{ route('admin.orders.wana.edit', $data->id) }}"
                                                            class="fa fa-edit text-dark">Edit</a>
                                                        <a href="{{ route('admin.orders.wana.destroy1', $data->id) }}"
