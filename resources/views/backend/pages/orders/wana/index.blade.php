        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-end">
                @if (Auth::guard('admin')->user()->can('orders.wana.edit'))
                    <a class="btn btn-rounded btn-primary" href="{{ route('admin.orders.wana.create') }}">Create New Order</a>
                @endif
            </div>
        </div>
    </div>
                                    ...
                                    <td> 
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-content" id="dropdownContent">
                                                <a href="{{ route('wana.invoice', $data['id']) }}" class="fa fa-eye text-dark">View</a>
