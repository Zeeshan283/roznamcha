...
@section('title')
    Update New Order Wana - Roznamcha
@endsection
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Update Order Wana</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Update Order Wana</h4>
                        @include('backend.layouts.partials.messages')

                        <form action="{{ route('admin.orders.wana.update', ['wana' => $record->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
            ...
            <div class="col-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="self">
                                <form class="table-responsive" action="{{ route('admin.order.updatewselfexpense', ['id' => $self_expense->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="self">
                                <form class="table-responsive" action="{{ route('admin.order.updatewself', ['id' => $self->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mt-2 collapse show" id="af_form" style="">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="col-sm-12 mb-2">
                                                <label for="custom">Malwala:</label>
                                                <select class="form-control  nice-select  form-select" name="name" id="product_owner_id">
                                                    <option value="{{$self->admin->id}}">{{$self->admin->name}}</option>
                                                    @foreach ($admins as $admin)
                                                        <option value="{{ $admin->id }}">{{ $admin->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <input class="form-control" id="af_self_total" autocomplete="off" value="{{$self->amount}}"
