...
@section('title')
    Edit Order Kharlachi - Roznamcha
@endsection
...
@section('admin-content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Edit Order Kharlachi</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class=" card">
                <div class="card-body">
                    <form action="{{route ('admin.orders.kharlachi.update', $record->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        ...
                        <div class=" row">
                            ...
                            <div class="col-sm-4 mb-2 not_torkham_field">
                                ...
                                <input type="text" name="extra_kiraya" id="extra_rent" value="{{ $record->extra_kiraya}}"
