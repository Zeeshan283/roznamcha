...
@section('title')
    Create New Order Kharlachi - Roznamcha
@endsection
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Create Order Kharlachi</h4>
            ...
            <div class="col-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="self">
                                <form class="table-responsive" action="{{ route('admin.order.kselfexpense') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="self">
                                <form class="table-responsive" action="{{ route('admin.order.kself') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
