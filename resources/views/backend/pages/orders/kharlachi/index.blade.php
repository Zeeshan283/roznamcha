            ...
            <div class="col-5 align-self-center">
                <div class="customize-input float-end">
                    @if (Auth::guard('admin')->user()->can('orders.kharlachi.edit'))
                        <a class="btn btn-rounded btn-primary" href="{{ route('admin.orders.kharlachi.create') }}">Create
                            New Order</a>
                    @endif
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table id="multi_col_order" class="table border table-striped table-bordered text-nowrap"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($KharlachiOrders as $data)
                                        <tr>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-content" id="dropdownContent">
                                                        <a href="{{ route('kharlachi.invoice', $data['id']) }}"
                                                            class="fa fa-eye text-dark">Invoice</a>
                                                        <a href="{{ route('kharlachi.images', $data['id']) }}"
                                                            class="fa fa-info-circle text-dark">Detail</a>
                                                        <a href="{{ route('admin.orders.kharlachi.edit', $data->id) }}"
                                                            class="fa fa-edit text-dark">Edit</a>
                                                        <a href="{{ route('admin.orders.kharlachi.destroy1', $data->id) }}"
