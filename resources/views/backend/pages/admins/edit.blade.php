...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Edir User</h4>
                    ...
                    <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST">
                        ...
                        <div class="form-row mb-3" style="display: flex; flex-wrap:wrap; justify-content: space-between">
                            <div class="form-group col-md-5 col-sm-6">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter Phone Number" required value="{{ $admin->phone }}">
                            </div>
                            <div class="form-group col-md-5 col-sm-6">
                        ...
                        <div class="form-row mb-3" style="display: flex; flex-wrap:wrap; justify-content: space-between">
                            <div class="form-group col-md-5 col-sm-6">
                                ...
                                <select class="form-control" id="currency" name="currency" required>
                                    ...
                                    <option value="all" {{ $admin->currency=="all" ? 'selected' : ''  }}>All</option>
                                    <option value="PK" {{ $admin->currency=="PK" ? 'selected' : ''  }}>PK</option>
                                    <option value="AF" {{ $admin->currency=="AF" ? 'selected' : ''  }}>AF</option>
