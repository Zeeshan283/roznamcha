...
class RoznamchaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'date' => 'required|date',
            'amount_pk' => 'required|numeric',
            'amount_af' => 'required|numeric',
        ...
        $data->amount_pk = $validatedData['amount_pk'];
        $data->amount_af = $validatedData['amount_af'];
        $data->amount_usa = $validatedData['amount_usd'];
